...
def init():
    def parse_args():
        ...
        parser.add_argument('--model', type=str, default='TCNN',
                            help="file name of the model, in src/models; available model: [ValueNetwork]")
        # path
        parser.add_argument('--data_root_path', type=str, default='./db_benchmark_datasets',
                            help="root of all datasets")
        parser.add_argument('--dataset', type=str, default='join-order-benchmark',
                            help="available datasets: [join-order-benchmark, TPCH]")
        ...
        parser.add_argument('--pairwise', type=bool, default=False,
                            help='whether to use pairwise. Need to disable sampling')
