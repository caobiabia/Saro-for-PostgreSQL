...
class CardPicker:
    def __init__(self, rows_arr, table_arr,
        ...
        # Each time we will adjust all the cardinalities of sub-queries in the same group (group by the number of
        # table here) And adjust according to the number of tables from more to less, because the more complex the
        # execution plan is, the more likely it is to produce wrong estimates on cardinality
